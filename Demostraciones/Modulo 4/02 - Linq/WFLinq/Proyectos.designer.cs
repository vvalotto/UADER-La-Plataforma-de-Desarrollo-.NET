...
namespace WFLinq
{
    ...
    partial void DeleteProyectos(Proyectos instance);
		...
		public ProyectosDataContext() : 
				base(global::WFLinq.Properties.Settings.Default.ProyectosConnectionString1, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnIDContactoChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Clientes_Clientes", Storage="_Clientes2", ThisKey="Id", OtherKey="Id", IsUnique=true, IsForeignKey=false)]
			...
			set
			{
							...
							|| (this._Clientes2.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.Clientes1 = null;
					}
					this._Clientes2.Entity = value;
					if ((value != null))
					{
						value.Clientes1 = this;
					}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Clientes_Clientes", Storage="_Clientes1", ThisKey="Id", OtherKey="Id", IsForeignKey=true)]
			...
			set
			{
							...
							|| (this._Clientes1.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.Clientes2 = null;
					}
					this._Clientes1.Entity = value;
					if ((value != null))
					{
						value.Clientes2 = this;
						this._Id = value.Id;
					}
					else
					{
